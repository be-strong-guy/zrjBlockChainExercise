...
func main() {
	//client, err := ethclient.Dial("https://sepolia.infura.io/v3/a64fa70728b0408987ecf73ddb7b5599")
	//client, err := ethclient.Dial("https://responsive-sleek-bridge.ethereum-sepolia.quiknode.pro/38df600a1df55961e9b597e2f7ae60c088c5e167/")
	client, err := ethclient.Dial("https://eth-sepolia.g.alchemy.com/v2/tSzwaEyy5RSW69g3GlBbi")
	//client, err := ethclient.Dial("wss://eth-sepolia.g.alchemy.com/v2/tSzwaEyy5RSW69g3GlBbi")
	//client, err := ethclient.Dial("wss://responsive-sleek-bridge.ethereum-sepolia.quiknode.pro/38df600a1df55961e9b597e2f7ae60c088c5e167/")
	if err != nil {
		log.Fatal(err)
	}
